...
CC =	cc
CFLAGS =  -pipe  -O -W -Wall -Wpointer-arith -Wno-unused -Werror -g  -Wno-pointer-sign -Wno-unsed-variable -Wno-type-limits -Wimplicit-fallthrough=0 -Wno-unsed-variable -Wno-char-subscripts
CPP =	cc -E
LINK =	$(CC)
...
ALL_INCS = -I src/core \
	...
	-I src/event/modules \
	-I src/os/unix \
	-I /home/kwabena/TaLoS/src/libressl-2.4.1/include \
	-I objs \
	-I src/http \
	-I src/http/modules \
	-I $(SGX_SDK)/include \
...
objs/nginx:	objs/src/core/nginx.o \
	...
	objs/addon/nginx_sgx_bank/ngx_sgx_bank_module.o \
	objs/ngx_modules.o
	...
	objs/src/http/modules/ngx_http_upstream_zone_module.o \
	objs/addon/nginx_sgx_bank/ngx_sgx_bank_module.o \
	nginx_sgx_bank/Enclaves_u/Enclave1/Untrusted/UserEnclave_u.o \
	nginx_sgx_bank/Enclaves_u/Enclave2/Untrusted/BalanceEnclave_u.o \
	objs/ngx_modules.o \
	-ldl -lpthread -lcrypt -lcrypto /usr/lib/x86_64-linux-gnu/libjansson.a -lpcre -ldl -lz \
	-L/opt/intel/sgxsdk/lib64 -L/opt/intel/sgxssl/lib64 \
	/home/kwabena/TaLoS/src/libressl-2.4.1/lib/libssl.a /home/kwabena/TaLoS/src/libressl-2.4.1/lib/libcrypto.a \
	-lsgx_urts -lsgx_uae_service -lsgx_usgxssl \
	-Wl,-E 
...
objs/addon/nginx_sgx_bank/ngx_sgx_bank_module.o:	$(ADDON_DEPS) \
	nginx_sgx_bank/ngx_sgx_bank_module.c
	$(CC) -c $(CFLAGS)  $(ALL_INCS) \
		-o objs/addon/nginx_sgx_bank/ngx_sgx_bank_module.o \
		nginx_sgx_bank/ngx_sgx_bank_module.c


# /home/kwabena/TaLoS/src/libressl-2.4.1/include/openssl/ssl.h:	objs/Makefile
# 	cd /home/kwabena/TaLoS/src/libressl-2.4.1 \
# 	&& if [ -f Makefile ]; then $(MAKE) clean; fi \
# 	&& ./config --prefix=/home/kwabena/TaLoS/src/libressl-2.4.1 no-shared  \
# 	&& $(MAKE) \
...
objs/nginx.8:	man/nginx.8 objs/ngx_auto_config.h
	sed -e "s|%%PREFIX%%|/home/kwabena/TaLoS/src/nginx-1.11.0/install|" \
		-e "s|%%PID_PATH%%|/home/kwabena/TaLoS/src/nginx-1.11.0/install/logs/nginx.pid|" \
		-e "s|%%CONF_PATH%%|/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/nginx.conf|" \
		-e "s|%%ERROR_LOG_PATH%%|/home/kwabena/TaLoS/src/nginx-1.11.0/install/logs/error.log|" \
		< man/nginx.8 > $@

install:	build 
	test -d '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install' || mkdir -p '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install'

	test -d '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/sbin' \
		|| mkdir -p '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/sbin'
	test ! -f '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/sbin/nginx' \
		|| mv '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/sbin/nginx' \
			'$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/sbin/nginx.old'
	cp objs/nginx '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/sbin/nginx'

	test -d '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf' \
		|| mkdir -p '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf'

	cp conf/koi-win '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf'
	cp conf/koi-utf '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf'
	cp conf/win-utf '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf'

	test -f '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/mime.types' \
		|| cp conf/mime.types '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf'
	cp conf/mime.types '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/mime.types.default'

	test -f '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/fastcgi_params' \
		|| cp conf/fastcgi_params '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf'
	cp conf/fastcgi_params \
		'$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/fastcgi_params.default'

	test -f '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/fastcgi.conf' \
		|| cp conf/fastcgi.conf '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf'
	cp conf/fastcgi.conf '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/fastcgi.conf.default'

	test -f '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/uwsgi_params' \
		|| cp conf/uwsgi_params '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf'
	cp conf/uwsgi_params \
		'$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/uwsgi_params.default'

	test -f '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/scgi_params' \
		|| cp conf/scgi_params '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf'
	cp conf/scgi_params \
		'$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/scgi_params.default'

	test -f '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/nginx.conf' \
		|| cp conf/nginx.conf '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/nginx.conf'
	cp conf/nginx.conf '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/conf/nginx.conf.default'

	test -d '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/logs' \
		|| mkdir -p '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/logs'

	test -d '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/logs' \
		|| mkdir -p '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/logs'

	test -d '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install/html' \
		|| cp -R html '$(DESTDIR)/home/kwabena/TaLoS/src/nginx-1.11.0/install'
